const Header = () => {
  return (
    <nav
      className="relative flex w-full flex-wrap items-center justify-between bg-[#260B2F] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:#260B2F lg:py-4"
      data-te-navbar-ref
    >
